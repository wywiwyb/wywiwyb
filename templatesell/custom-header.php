...
add_action( 'after_setup_theme', 'springy_custom_header_setup' );

if ( ! function_exists( 'springy_header_style' ) ) :
	/**
	 * Styles the header image and text displayed on the blog.
	 *
	 * @see springy_custom_header_setup().
	 */
	function springy_header_style() {
